...
describe("non-color tokens match design-spec.md §2 / §3", () => {
  const nonColorTokens: Record<string, string> = {
    ...
    "spacing-iconbutton-p-md": "10px",
    "spacing-iconbutton-p-sm": "5px",
    ...
    "spacing-input-gap-lg": "8px",
    "spacing-input-gap-md": "8px",
    "spacing-input-gap-sm": "4px",
    "spacing-input-stack-gap": "4px",
